...
$errors = $_SESSION['flash']['errores'] ?? [];
$infoAntigua = $_SESSION['inf_vieja'] ?? [];
$verdadero = $_SESSION['flash']['añadido'] ?? [];
?>
@extends('plantilla')
...
@section('content')
    <form action="{{ mi_route('errores') }}" method="post" class="FormularioTarea" enctype="multipart/form-data">
        <fieldset>
            <legend><strong>Formulario Tarea</strong></legend>
            ...
            <input name="NIF" type="text" value="{{ $infoAntigua['NIF'] ?? '' }}"><br>
            ...
            <input name="nombre" type="text" value="{{ $infoAntigua['nombre'] ?? '' }}"><br>
            ...
            <input name="apellidos" type="text" value="{{ $infoAntigua['apellidos'] ?? '' }}"><br>
            ...
            <input name="telefono" type="text" value="{{ $infoAntigua['telefono'] ?? '' }}"><br>
            ...
            <textarea name="descripcion">{{ $infoAntigua['descripcion'] ?? '' }}</textarea><br>
            ...
            <input name="email" type="text" value="{{ $infoAntigua['email'] ?? '' }}"><br>
            ...
            <input name="direccion" type="text" value="{{ $infoAntigua['direccion'] ?? '' }}"><br>
            ...
            <input name="poblacion" type="text" value="{{ $infoAntigua['poblacion'] ?? '' }}"><br>
            ...
            <input name="codigoPostal" type="text" value="{{ $infoAntigua['codigoPostal'] ?? '' }}"><br>
            ...
            <input name="fechaRealizacion" type="date" value="{{ $infoAntigua['fechaRealizacion'] ?? '' }}"><br>
            ...
            <textarea name="anotacionesAnteriores" id="anotacionesAnteriores">{{ $infoAntigua['anotacionesAnteriores'] ?? '' }}</textarea><br>
            ...
            <textarea name="anotacionesPosteriores" id="anotacionesPosteriores">{{ $infoAntigua['anotacionesPosteriores'] ?? '' }}</textarea><br>
